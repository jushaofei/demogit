...
import com.example.demo.word.AccurateBasic;
...
public class UploadController {
    ...
    @RequestMapping(path = "/aip/pdfRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过照片识别通用文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = AccurateBasic.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = AccurateBasic.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
