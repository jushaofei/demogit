...
import com.example.demo.word.BusinessCard;
...
public class BusinessCardController {
    ...
    @RequestMapping(path = "/aip/businesscardRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过名片识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = BusinessCard.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = BusinessCard.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
