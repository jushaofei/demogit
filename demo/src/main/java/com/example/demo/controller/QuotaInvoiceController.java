...
import com.example.demo.word.QuotaInvoice;
...
@RestController
@Api(tags = "定额发票识别")
public class QuotaInvoiceController {

    private static String sava_path="D:/demo/src/main/java/com/example/demo/word/images/";
    private static String[] list={"png","jpg","pdf"};

    @RequestMapping(path = "/aip/quotainvoiceRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过定额发票识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word =  QuotaInvoice.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word =  QuotaInvoice.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
