...
import com.example.demo.word.HouseholdRegister;
...
@RestController
@Api(tags = "户口本识别")
public class HouseholdRegisterController {

    private static String sava_path="D:/demo/src/main/java/com/example/demo/word/images/";
    private static String[] list={"png","jpg","pdf"};

    @RequestMapping(path = "/aip/householdregisterRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过户口本识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = HouseholdRegister.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = HouseholdRegister.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
