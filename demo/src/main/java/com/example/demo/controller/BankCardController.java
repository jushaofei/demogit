...
import com.example.demo.word.BankCard;
...
public class BankCardController {
    ...
    @RequestMapping(path = "/aip/bankcardRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过银行卡识别照片识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = BankCard.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = BankCard.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
