...
import com.example.demo.word.Passport;
...
public class PassportController {
    ...
    @RequestMapping(path = "/aip/passportRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过护照识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = Passport.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = Passport.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
