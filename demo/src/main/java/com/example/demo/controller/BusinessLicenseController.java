...
import com.example.demo.word.BusinessLicense;
...
public class BusinessLicenseController {
    ...
    @RequestMapping(path = "/aip/businesRecog", method = {RequestMethod.POST})
    @ApiOperation(value = "通过营业执照照片识别文字的方法")
            ...
            if (type != null ) {// 判断文件类型是否为空
                ...
                if (type.equals("png") || type.equals("jpg")){
                    if (ak != null | sk != null) {
                        ...
                        word = BusinessLicense.accurateBasic(sava_path + fileName, accessToken);
                    }else {
                        word = BusinessLicense.accurateBasic(sava_path + fileName, accessToken);
                    }
                }else {
